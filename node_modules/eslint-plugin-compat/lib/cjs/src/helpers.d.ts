import { AstMetadataApiWithTargetsResolver, BrowserListConfig, BrowsersListOpts, Context, ESLintNode, HandleFailingRule, SourceCode, Target } from "./types";
...
export declare function lintLiteral(context: Context, handleFailingRule: HandleFailingRule, rules: AstMetadataApiWithTargetsResolver[], sourceCode: SourceCode, node: ESLintNode): void;
